...
/* This is implemtation of Fork/Join  */

import java.io.*;
import java.util.*;
import java.util.concurrent.*;

/*  This classs is responsible to read the content of the files */

class Document {
	//This List is responsible to store the lines in File
...
/* This class is responsible for rading the files and subfolder in given directory
 * fromDirectory returns the Folder object having list of subfolders and documents(files) in it
 *  */
...
/* This class contains the method to calculate the number of times the word occured in line */
...
public class WordCounter {    
    ...
    String[] wordsIn(String line) {
        return line.trim().split("(\\s|\\p{Punct})+"); //Returns String array by splitting on blank spaces OR punctuations
    }
...
/* This class is responsible to calculate the occurences of given word in document*/
...
/*This class operates on the folder structure */
